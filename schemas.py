...
class RecipeIn(RecipeBase):
    ...
    ingredients: str = Field(
        ...,
        min_length=3,
        description="Список ингредиентов (каждый с новой строки или через запятую)",
        examples=[
            "Спагетти - 400г\nБекон - 200г\nЯйца - 3 шт\nПармезан - 100г\nСливки - 100мл",
            "Спагетти - 400г, бекон - 200г, яйца - 3 шт, пармезан - 100г, сливки - 100мл",
        ],
    )
...
class RecipeOut(RecipeBase):
    ...
    views: int = Field(
        default=0, description="Количество просмотров рецепта", examples=[1, 42]
    )
